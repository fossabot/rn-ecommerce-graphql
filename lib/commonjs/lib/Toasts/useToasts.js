...
exports.useToasts = exports.getToastId = void 0;

var _react = require("react");

var _useToastContext = require("./useToastContext");
...
const getToastId = ({
  ...
  const combined = [type, message, dismissable, actionText, icon].join(); // The hashing function below should generally avoid accidental collisions.
...
exports.getToastId = getToastId;

const useToasts = () => {
  const [state, dispatch] = (0, _useToastContext.useToastContext)();
  /**
  ...
  const addToast = (0, _react.useCallback)(
  /**
  ...
  toastProps => {
    ...
    const handleAction = () => onAction ? onAction(() => removeToast(id)) : () => {}; // A timeout of 0 means no auto-dismiss.
