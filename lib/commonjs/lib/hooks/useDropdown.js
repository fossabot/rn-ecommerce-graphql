...
const useDropdown = () => {
  ...
  const [expanded, setExpanded] = (0, _react.useState)(false); // collapse on mousedown outside of the element and trigger.

  const maybeCollapse = (0, _react.useCallback)(({
    target
  }) => {
  ...
  (0, _useEventListener.useEventListener)(document, 'mousedown', maybeCollapse);
  /**
