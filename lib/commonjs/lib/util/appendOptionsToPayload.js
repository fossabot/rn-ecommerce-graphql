...
exports.appendOptionsToPayload = void 0;

var _findMatchingProductVariant = require("./findMatchingProductVariant");
...
const appendOptionsToPayload = (payload, optionSelections, optionCodes = null) => {
  ...
  const selectedVariant = (0, _findMatchingProductVariant.findMatchingVariant)({
    variants,
    optionCodes,
    optionSelections
  });
...
exports.appendOptionsToPayload = appendOptionsToPayload;
//# sourceMappingURL=appendOptionsToPayload.js.map