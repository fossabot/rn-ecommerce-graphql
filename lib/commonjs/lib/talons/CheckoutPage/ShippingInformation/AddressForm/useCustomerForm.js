...
exports.useCustomerForm = void 0;
...
const useCustomerForm = props => {
  ...
  }] = (0, _client.useMutation)(createCustomerAddressMutation);
  const [updateCustomerAddress, {
    error: updateCustomerAddressError,
    loading: updateCustomerAddressLoading
  }] = (0, _client.useMutation)(updateCustomerAddressMutation);
  const {
    data: customerData,
  ...
  let initialValues = { ...shippingData,
    country: countryCode
  };
  ...
  const errors = (0, _react.useMemo)(() => new Map([['createCustomerAddressMutation', createCustomerAddressError], ['updateCustomerAddressMutation', updateCustomerAddressError]]), [createCustomerAddressError, updateCustomerAddressError]);
  return {
    errors,
    handleCancel,
    handleSubmit,
...
//# sourceMappingURL=useCustomerForm.js.map