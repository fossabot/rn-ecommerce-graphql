...
exports.useCreditCard = exports.mapAddressData = void 0;
...
exports.mapAddressData = mapAddressData;
...
const useCreditCard = props => {
  ...
  const [isDropinLoading, setDropinLoading] = (0, _react.useState)(true);
  const [shouldRequestPaymentNonce, setShouldRequestPaymentNonce] = (0, _react.useState)(false);
  const [shouldTeardownDropin, setShouldTeardownDropin] = (0, _react.useState)(false);
  /**
  ...
  } = (0, _client.useQuery)(getBillingAddressQuery, {
    skip: !cartId,
    variables: {
      cartId
    }
  ...
  } = (0, _client.useQuery)(getShippingAddressQuery, {
    skip: !cartId,
    variables: {
      cartId
    }
  ...
  } = (0, _client.useQuery)(getIsBillingAddressSameQuery, {
    skip: !cartId,
    variables: {
      cartId
    }
  ...
  }] = (0, _client.useMutation)(setBillingAddressMutation);
  const [updateCCDetails, {
    error: ccMutationError,
    called: ccMutationCalled,
    loading: ccMutationLoading
  }] = (0, _client.useMutation)(setCreditCardDetailsOnCartMutation);
  ...
  const setIsBillingAddressSameInCache = (0, _react.useCallback)(() => {
    client.writeQuery({
  ...
  const setShippingAddressAsBillingAddress = (0, _react.useCallback)(() => {
  ...
  const setBillingAddress = (0, _react.useCallback)(() => {
    const {
      firstName,
      lastName,
      country,
  ...
  const setPaymentDetailsInCache = (0, _react.useCallback)(braintreeNonce => {
    /**
  ...
  const updateCCDetailsOnCart = (0, _react.useCallback)(braintreeNonce => {
    const {
      nonce
    } = braintreeNonce;
    updateCCDetails({
  ...
  const onPaymentSuccess = (0, _react.useCallback)(braintreeNonce => {
  ...
  const onPaymentError = (0, _react.useCallback)(error => {
    setStepNumber(0);
  ...
  const onPaymentReady = (0, _react.useCallback)(() => {
  ...
  const resetShouldTeardownDropin = (0, _react.useCallback)(() => {
  ...
  const errors = (0, _react.useMemo)(() => new Map([['setBillingAddressMutation', billingAddressMutationError], ['setCreditCardDetailsOnCartMutation', ccMutationError]]), [billingAddressMutationError, ccMutationError]);
  return {
    errors,
    onPaymentError,
    onPaymentSuccess,
