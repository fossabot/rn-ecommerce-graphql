...
exports.usePlaceholderImage = void 0;
...
const usePlaceholderImage = props => {
  const {
    ...
    imageHasError,
    imageIsLoaded
  } = props; // Render the placeholder unless we've been told not to,
...
exports.usePlaceholderImage = usePlaceholderImage;
//# sourceMappingURL=usePlaceholderImage.js.map