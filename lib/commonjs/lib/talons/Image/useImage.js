...
exports.useImage = exports.UNCONSTRAINED_SIZE_KEY = void 0;
...
exports.UNCONSTRAINED_SIZE_KEY = UNCONSTRAINED_SIZE_KEY;
...
const useImage = props => {
  ...
  const handleImageLoad = (0, _react.useCallback)(() => {
    setIsLoaded(true);
  ...
  }, [onError]); // Use the unconstrained / default entry in widths.

  const resourceWidth = (0, _react.useMemo)(() => {
    if (width) {
      return width;
  ...
  const resourceHeight = (0, _react.useMemo)(() => {
    if (height) {
      return height;
