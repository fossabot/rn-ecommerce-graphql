...
exports.useCategoryTree = void 0;
...
const useCategoryTree = props => {
  ...
  const childCategories = (0, _react.useMemo)(() => {
    const childCategories = new Map(); // Add the root category when appropriate.
...
//# sourceMappingURL=useCategoryTree.js.map