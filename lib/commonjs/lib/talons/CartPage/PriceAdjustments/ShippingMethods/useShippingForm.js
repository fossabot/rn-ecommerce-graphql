...
exports.useShippingForm = exports.MOCKED_ADDRESS = void 0;
...
exports.MOCKED_ADDRESS = MOCKED_ADDRESS;
...
const useShippingForm = props => {
  ...
  }] = (0, _client.useMutation)(setShippingAddressMutation);
  (0, _react.useEffect)(() => {
  ...
  const handleZipChange = (0, _react.useCallback)(zip => {
      ...
      if (shippingAddresses.length) {
        ...
        if (availableMethods.length) {
          apolloClient.writeQuery({
            ...
            data: {
              cart: { ...cart,
                shipping_addresses: [{ ...primaryAddress,
  ...
  const handleOnSubmit = (0, _react.useCallback)(formValues => {
    const {
      country,
      region,
      zip
  ...
  const errors = (0, _react.useMemo)(() => new Map([['setShippingAddressMutation', errorSettingShippingAddress]]), [errorSettingShippingAddress]);
  return {
    errors,
    handleOnSubmit,
    handleZipChange,
