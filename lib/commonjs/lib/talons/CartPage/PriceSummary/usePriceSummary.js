...
exports.usePriceSummary = void 0;
...
const usePriceSummary = props => {
  ...
  const history = (0, _reactRouterDom.useHistory)(); // We don't want to display "Estimated" or the "Proceed" button in checkout.

  const match = (0, _reactRouterDom.useRouteMatch)('/checkout');
  const isCheckout = !!match;
  const {
    error,
    loading,
    data
  } = (0, _client.useQuery)(getPriceSummary, {
...
exports.usePriceSummary = usePriceSummary;
//# sourceMappingURL=usePriceSummary.js.map