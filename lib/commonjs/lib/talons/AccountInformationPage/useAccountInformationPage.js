...
exports.useAccountInformationPage = void 0;
...
const useAccountInformationPage = props => {
  ...
  const [shouldShowNewPassword, setShouldShowNewPassword] = (0, _react.useState)(false);
  const [isUpdateMode, setIsUpdateMode] = (0, _react.useState)(false); // Use local state to determine whether to display errors or not.
  ...
  const {
    ...
    error: loadDataError
  } = (0, _client.useQuery)(getCustomerInformationQuery, {
    skip: !isSignedIn,
  ...
  }] = (0, _client.useMutation)(setCustomerInformationMutation);
  const [changeCustomerPassword, {
    error: customerPasswordChangeError,
    loading: isChangingCustomerPassword
  }] = (0, _client.useMutation)(changeCustomerPasswordMutation);
  ...
  const handleChangePassword = (0, _react.useCallback)(() => {
...
exports.useAccountInformationPage = useAccountInformationPage;
//# sourceMappingURL=useAccountInformationPage.js.map