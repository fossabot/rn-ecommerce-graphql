...
exports.deleteCacheEntry = void 0;
 ...
 */
const deleteCacheEntry = async (client, predicate) => {
  // If there is no client or cache then just back out since it doesn't matter :D
  if (!client || !client.cache || !client.cache.data || !client.cache.data.data) {
    if (process.env.NODE_ENV === 'development') {
      console.warn('Apollo Cache entry deletion attempted without client or cache.');
    }
...
//# sourceMappingURL=deleteCacheEntry.js.map