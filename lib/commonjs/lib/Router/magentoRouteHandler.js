...
var _resolveUnknownRoute = _interopRequireDefault(require("./resolveUnknownRoute"));
...
class MagentoRouteHandler extends _react.Component {
  constructor(...args) {
    super(...args);
  ...
  async getRouteComponent() {
    ...
    try {
      ...
      const symbol = e.message === '404' ? NotFound : InternalError; // we don't have a matching RootComponent, but we've checked for one
  ...
  renderChildren(loading) {
    ...
    return typeof children === 'function' ? children({ ...errorState,
      loading
    }) : null;
  }
  ...
  render() {
    ...
    const {
      RootComponent,
      ...routeProps
    } = componentMap.get(pathname);
    return /*#__PURE__*/_react.default.createElement(RootComponent, _extends({}, routeProps, {
      key: pathname
    }));
  }
...
exports.default = MagentoRouteHandler;
