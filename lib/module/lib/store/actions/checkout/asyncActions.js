...
export const beginCheckout = () => async function thunk(dispatch) {
...
export const cancelCheckout = () => async function thunk(dispatch) {
  dispatch(actions.reset());
};
export const resetCheckout = () => async function thunk(dispatch) {
  await dispatch(closeDrawer());
  dispatch(actions.reset());
};
export const resetReceipt = () => async function thunk(dispatch) {
  await dispatch(actions.receipt.reset());
};
export const submitPaymentMethodAndBillingAddress = payload => async function thunk(dispatch) {
  const {
    countries,
    formValues
  } = payload;
...
export const submitBillingAddress = payload => async function thunk(dispatch, getState) {
...
export const submitPaymentMethod = payload => async function thunk(dispatch, getState) {
...
export const submitShippingAddress = (payload = {}) => async function thunk(dispatch, getState) {
...
export const submitShippingMethod = payload => async function thunk(dispatch, getState) {
...
export const submitOrder = ({
  ...
  try {
    ...
    dispatch(actions.receipt.setOrder({
      id: response,
      shipping_address
