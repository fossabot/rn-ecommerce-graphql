...
const cache = new Map();
export const filterProps = (props = {}, exclusions = []) => Object.entries(props).reduce((r, [k, v]) => {
...
const fromRenderProp = (elementType, customProps = []) => {
  ...
  if (!cache.has(key)) {
    ...
    const Component = props => /*#__PURE__*/React.createElement(elementType, filterProps(props, uniqueCustomProps));
