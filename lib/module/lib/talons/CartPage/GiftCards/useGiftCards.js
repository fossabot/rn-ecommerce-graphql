...
import { useCartContext } from '@magento/peregrine/lib/context/cart'; // To keep track of the most recent action taken.
...
export const useGiftCards = props => {
  ...
  const removeGiftCard = useCallback(async giftCardCode => {
