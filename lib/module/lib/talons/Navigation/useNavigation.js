...
export const useNavigation = props => {
  ...
  const fetchUserDetails = useAwaitQuery(customerQuery); // request data from server
  ...
  const [categoryId, setCategoryId] = useState(rootCategoryId); // define local variables
