...
export const useAuthModal = props => {
  ...
  const history = useHistory(); // If the user is authed, the only valid view is "MY_ACCOUNT".
  ...
  const handleSignOut = useCallback(async () => {
    ...
    await clearCustomerDataFromCache(apolloClient); // Refresh the page as a way to say "re-initialize". An alternative
