...
const CartContextProvider = props => {
  ...
  const contextValue = useMemo(() => [derivedCartState, cartApi], [cartApi, derivedCartState]);
...
const CREATE_CART_MUTATION = gql(_templateObject());
const CART_DETAILS_QUERY = gql(_templateObject2());
