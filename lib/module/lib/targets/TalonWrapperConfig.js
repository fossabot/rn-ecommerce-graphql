...
class TalonWrapperConfig {
  ...
  constructor(addTransforms) {
    ...
    this.ProductFullDetail = {
       ...
       * @type {WrappableTalon}
       */
      useProductFullDetail: new WrappableTalon(addTransforms, 'ProductFullDetail/useProductFullDetail')
    };
    /**
...
class WrappableTalon {
  ...
  wrapWith(wrapperModule) {
    this.addTransform({
      ...
      transformModule: '@magento/pwa-buildpack/lib/WebpackTools/loaders/wrap-esm-loader',
      options: {
        wrapperModule,
...
//# sourceMappingURL=TalonWrapperConfig.js.map